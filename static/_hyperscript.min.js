(function (e, t) {
  ...
  function h(t) {
    ...
    t.addGrammarElement('beepExpression', function (e, t, r) {
      ...
      if (n) {
        ...
        n.evaluate = function (e) {
          ...
          let o = e.me;
          if (
            t.triggerEvent(o, 'hyperscript:beep', {
              element: o,
              expression: n,
              value: r,
            })
    ...
    t.addCommand('if', function (e, t, r) {
      ...
      var a = false;
      if (r.matchToken('else') || r.matchToken('otherwise')) {
        a = r.peekToken('if');
        var o = e.parseElement('commandList', r);
      }
      if (r.hasMore() && !a) {
        r.requireToken('end');
      }
